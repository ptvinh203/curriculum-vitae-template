                    ...
                    <div class="flex gap-10">
                        ...
                        <div class="flex-wrap flex flex-col gap-5 justify-center w-1/3">
                            <div id="field" class="flex gap-5 items-center">
                                ...
                                <input name="fullname" id="value" class="text-lg text-slate-600 font-medium p-1 rounded-lg border-2 border-slate-300" value="<%=cv.getBasicInfo().getName()%>" placeholder="Your name" />
                            </div>
                            <div id="field" class="flex gap-5 items-center">
                                <div id="label" class="font-bold text-lg text-[#164B60]">
                                    Email:
                                </div>
                                <input name="email" id="value" class="text-lg text-slate-600 font-medium p-1 rounded-lg border-2 border-slate-300" value="<%=cv.getBasicInfo().getEmail()%>" placeholder="Your email" />
                            </div>
                            <div id="field" class="flex gap-5 items-center">
                                <div id="label" class="font-bold text-lg text-[#164B60]">
                                    Phone number:
                                </div>
                                <input name="phoneNumber" id="value" class="text-lg text-slate-600 font-medium p-1 rounded-lg border-2 border-slate-300" value="<%=cv.getBasicInfo().getPhone()%>" placeholder="Your phone number" />
                            </div>
                            <div id="field" class="flex gap-5 items-center">
                                <div id="label" class="font-bold text-lg text-[#164B60]">
                                    Address:
                        ...
                        <div class="w-1/3 flex flex-col justify-between">
                            ...
                            <div id="refrence-links-container">
                                <div id="github" class="flex gap-5 items-center">
                                    ...
                                    <input name="githubLink" id="value" class="text-lg text-slate-600 font-medium p-1 rounded-lg border-2 border-slate-300" value="<%=cv.getBasicInfo().getGithub()%>" placeholder="Your github link" />
                                </div>
